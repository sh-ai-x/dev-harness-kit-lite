...
11 skills for 4-hour MVP/POC team sprints.
...
| `/dev-kit-lite:role` | 1.3 | Manage role taxonomy (planner/frontend/backend/ai/design) with responsibility-area separation + tech-stack-agnostic presets. SSOT for plan/plan-update/team-roster/build-tdd. |
| `/dev-kit-lite:migrate` | 1.4 | Adopt dev-kit-lite into an EXISTING project. Detects layout/tooling/ownership automatically. Layout-agnostic — same skill for one repo, workspace, or multi-repo. |

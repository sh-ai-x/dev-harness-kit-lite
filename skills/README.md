...
| `/dev-kit-lite:role` | 1.3 | Manage role taxonomy (planner/frontend/backend/ai/design) with SRP-aware directory separation. SSOT for plan/plan-update/team-roster/build-tdd. |

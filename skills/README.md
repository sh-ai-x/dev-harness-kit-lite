...
| `/dev-kit-lite:role` | 1.3 | Manage role taxonomy (planner/frontend/backend/ai/design) with responsibility-area separation + tech-stack-agnostic presets (no baked-in Next.js / FastAPI defaults). SSOT for plan/plan-update/team-roster/build-tdd. |
